...
`SELECT F.nombre_fabricante, AVG(A.precio_articulo) AS promedio FROM Articulo A JOIN Fabricante F ON A.id_fabricante = F.id_fabricante GROUP BY F.nombre_fabricante;`
